...
public class RecipeSelectionButton extends AbstractButton {
    private static final WidgetSprites TEXTURES = new WidgetSprites(Constants.id("widget/button"), Constants.id( "widget/button_disabled"), Constants.id("widget/button_highlighted"));
