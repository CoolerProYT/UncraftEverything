...
public class ColorPickerWidget extends AbstractWidget {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        int i = FastColor.ARGB32.color(1, getFGColor());
        graphics.fill(screenWidth / 2 + 10 + 1, this.getY() + 1, screenWidth / 2 + 10 + buttonWidth - 1, this.getY() + BUTTON_HEIGHT - 1, FastColor.ARGB32.color(0xDD, color));
        ...
        graphics.drawCenteredString(minecraft.font, this.getMessage() , screenWidth / 2, screenHeight / 2 - 100 + 2 + minecraft.font.lineHeight / 2, FastColor.ARGB32.color(0xFF, ChatFormatting.WHITE.getColor()));
        ...
        graphics.blitSprite(VANILLA_SPRITES.get(this.active, this.isSaveHoveredOrFocused), confirmX, btnY, scaledButtonWidth, BUTTON_HEIGHT);
        ...
        graphics.blitSprite(VANILLA_SPRITES.get(this.active, this.isCancelHoveredOrFocused), cancelX, btnY, scaledButtonWidth, BUTTON_HEIGHT);
