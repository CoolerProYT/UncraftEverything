...
public abstract class AbstractScrollableScreen extends Screen {
    private static final Identifier SCROLLER_SPRITE = new Identifier(UncraftEverything.MODID, "textures/gui/widget/scroller.png");
    private static final Identifier SCROLLER_BACKGROUND_SPRITE = new Identifier(UncraftEverything.MODID,"textures/gui/widget/scroller_background.png");
    ...
    protected void renderScrollbar(DrawContext guiGraphics, int footerHeight) {
        ...
        if (getMaxScroll() > 0){
            guiGraphics.drawNineSlicedTexture(SCROLLER_BACKGROUND_SPRITE, i, 25, 6, this.height - footerHeight, 6, this.height - footerHeight, 0, this.height - footerHeight, 6, 32);
