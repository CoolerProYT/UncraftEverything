...
public abstract class AbstractScrollableScreen extends Screen {
    ...
    protected void renderScrollbar(DrawContext guiGraphics, int footerHeight) {
        ...
        if (getMaxScroll() > 0){
            guiGraphics.drawGuiTexture(RenderLayer::getGuiTextured, SCROLLER_BACKGROUND_SPRITE, i, 25, 6, this.height - footerHeight);
            guiGraphics.drawGuiTexture(RenderLayer::getGuiTextured, SCROLLER_SPRITE, i, k, 6, j);
        }
    }
