...
public class UEConfigScreen extends AbstractScrollableScreen {
    ...
    protected void init() {
        ...
        restrictionTypeButton = new Button(
                ...
                new TranslatableComponent("screen.uncrafteverything.config.restriction_type_" + restrictionType.toString().toLowerCase()),
        ...
        toggleEnchantedBtn = new Button(x, (int) (baseY + 120 - scrollAmount), widgetWidth, 20,
                new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_enchanted_", allowEnchantedItems)), btn -> {
                allowEnchantedItems = !allowEnchantedItems;
                btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_enchanted_", allowEnchantedItems)));
        });
        this.addRenderableWidget(toggleEnchantedBtn);

        // Toggle for experienceType
        toggleEnchantmentTypeBtn = new Button(x, (int) (baseY + 145 - scrollAmount), widgetWidth, 20,
                new TranslatableComponent("screen.uncrafteverything.config.exp_type_" + experienceType.toString().toLowerCase()),
                btn -> {
                    ...
                    experienceType = next;
                    btn.setMessage(new TranslatableComponent("screen.uncrafteverything.config.exp_type_" + next.toString().toLowerCase()));
                }
        );
        this.addRenderableWidget(toggleEnchantmentTypeBtn);

        // Experience input box
        experienceInput = new EditBox(this.font, x, (int) (baseY + 170 - scrollAmount), widgetWidth, 20, new TranslatableComponent("screen.uncrafteverything.blank"));
        ...
        toggleAllowUnsmithing = new Button(x, (int) (baseY + 195 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_unsmithing_", allowUnsmithing)), btn -> {
            allowUnsmithing = !allowUnsmithing;
            btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_unsmithing_", allowUnsmithing)));
        });
        this.addRenderableWidget(toggleAllowUnsmithing);

        toggleAllowDamaged = new Button(x, (int) (baseY + 220 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_damaged_", allowDamagedItems)), btn -> {
                allowDamagedItems = !allowDamagedItems;
            btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_damaged_", allowDamagedItems)));
        });
        ...
        togglePreventModdedIngredientsFromVanillaItems = new Button(x, (int) (baseY + 245 - scrollAmount), widgetWidth, 20,
                new TranslatableComponent(getLabel("screen.uncrafteverything.config.prevent_modded_ingredients_from_vanilla_items_", preventModdedIngredientsFromVanillaItems)), btn -> {
                preventModdedIngredientsFromVanillaItems = !preventModdedIngredientsFromVanillaItems;
                btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.prevent_modded_ingredients_from_vanilla_items_", preventModdedIngredientsFromVanillaItems)));
        });
        ...
        toggleEnableProgression = new Button(x, (int) (baseY + 365 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.enable_progression_", enableProgression)), btn -> {
            enableProgression = !enableProgression;
            btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.enable_progression_", enableProgression)));
        });
        this.addRenderableWidget(toggleEnableProgression);

        toggleOnlyAllowDefinedProgression = new Button(x, (int) (baseY + 390 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.only_allow_defined_progression_", onlyAllowDefinedProgression)), btn -> {
            onlyAllowDefinedProgression = !onlyAllowDefinedProgression;
            btn.setMessage(new TranslatableComponent(getLabel("screen.uncrafteverything.config.only_allow_defined_progression_", onlyAllowDefinedProgression)));
        });
    ...
    public void renderBackground(@NotNull PoseStack pPoseStack) {
        ...
        MinecraftForge.EVENT_BUS.post(new ScreenEvent.BackgroundDrawnEvent(this, pPoseStack));
    ...
    public void render(@NotNull PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        RenderSystem.enableScissor(0, clipTop * scale, this.width * scale, clipHeight * scale);
        ...
        font.draw(pPoseStack, new TranslatableComponent("screen.uncrafteverything.config.restriction_type_label"), x, (int) (baseY - scrollAmount + (this.font.lineHeight / 2d) + 2), 0xFFFFFFFF);

        Component format = new TranslatableComponent("screen.uncrafteverything.config.restricted_item_label");
        font.drawWordWrap(format, x, (int) (baseY + 25 - scrollAmount + (this.font.lineHeight / 2d) + 20), textWidth,0xFFFFFFFF);

        List<FormattedCharSequence> formattedCharSequence = this.font.split(new TranslatableComponent("screen.uncrafteverything.config.format_label"), (int) (textWidth * 1.5));
        int lineHeight = 0;
        ...
        Component allowEnchantedItem = new TranslatableComponent("screen.uncrafteverything.config.allow_enchanted_label");
        font.drawWordWrap(allowEnchantedItem, x, (int) (baseY + 120 - scrollAmount + (this.font.lineHeight / 2d) + 1 - this.font.wordWrapHeight(allowEnchantedItem.getContents(), textWidth) / 4d), textWidth, 0xFFFFFFFF);

        font.drawWordWrap(new TranslatableComponent("screen.uncrafteverything.config.exp_type_label"), x, (int) (baseY + 145 - scrollAmount + (this.font.lineHeight / 2d) + 2), textWidth,0xFFFFFFFF);

        Component expRequired = new TranslatableComponent("screen.uncrafteverything.config.exp_required_label");
        font.drawWordWrap(expRequired, x, (int) (baseY + 170 - scrollAmount + (this.font.lineHeight / 2d) + 1 - this.font.wordWrapHeight(expRequired.getContents(), textWidth) / 4d), textWidth,0xFFFFFFFF);

        font.drawWordWrap(new TranslatableComponent("screen.uncrafteverything.config.allow_unsmithing_label"), x, (int) (baseY + 195 - scrollAmount + (this.font.lineHeight / 2d) + 2), textWidth, 0xFFFFFFFF);
        ...
        Component enableProgression = new TranslatableComponent("screen.uncrafteverything.config.enable_progression");
        ...
        Component onlyAllowDefined = new TranslatableComponent("screen.uncrafteverything.config.only_allow_defined_progression");
        ...
        drawCenteredString(pPoseStack, this.font, new TranslatableComponent("screen.uncrafteverything.uncraft_everything_config").setStyle(Style.EMPTY.withUnderlined(true)), this.width / 2, 4, 0xFFFFFFFF);
    ...
    private void pressRestrictionTypeButton(Button button){
        ...
        button.setMessage(new TranslatableComponent("screen.uncrafteverything.config.restriction_type_" + next.toString().toLowerCase()));
    }
    ...
    private void renderButtonTooltip(PoseStack poseStack, int mouseX, int mouseY){
        if (restrictionTypeButton.isHoveredOrFocused()){
        ...
        if (toggleEnchantedBtn.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (toggleEnchantmentTypeBtn.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (experienceInput.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (toggleAllowUnsmithing.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (toggleAllowDamaged.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (togglePreventModdedIngredientsFromVanillaItems.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (toggleEnableProgression.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
        ...
        if (toggleOnlyAllowDefinedProgression.isHoveredOrFocused()){
            List<Component> tooltip = List.of(
    ...
    private Component title(String title){
        return new TranslatableComponent(title).withStyle(ChatFormatting.BLUE);
    }

    private Component valueInfo(String value, String info){
        return new TranslatableComponent(value).append(": ").withStyle(ChatFormatting.AQUA).append(new TranslatableComponent(info).withStyle(ChatFormatting.GRAY));
    }

    private Component description(String desc){
        return new TranslatableComponent(desc).withStyle(ChatFormatting.GRAY);
    }
}
