...
public class UEConfigScreen extends AbstractScrollableScreen {
    ...
    protected void init() {
        ...
        Button toggleAllowUnsmithing = new Button(x, (int) (baseY + 195 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_unsmithing_", allowUnsmithing)), btn -> {
        ...
        Button toggleAllowDamaged = new Button(x, (int) (baseY + 220 - scrollAmount), widgetWidth, 20, new TranslatableComponent(getLabel("screen.uncrafteverything.config.allow_damaged_", allowDamagedItems)), btn -> {
