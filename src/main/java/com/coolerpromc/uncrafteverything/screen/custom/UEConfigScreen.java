...
public class UEConfigScreen extends AbstractScrollableScreen {
    ...
    protected void renderSeparator(DrawContext guiGraphics){
        ...
        guiGraphics.drawTexture(RenderLayer::getGuiTextured, header, 0, 25 - 2, 0.0F, 0.0F, this.width, 2, 32, 2);
        guiGraphics.drawTexture(RenderLayer::getGuiTextured, footer, 0, this.height - 45, 0.0F, 0.0F, this.width, 2, 32, 2);
    }
