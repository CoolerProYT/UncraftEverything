...
public class UEItemTagGenerator extends ItemTagsProvider {
    public UEItemTagGenerator(DataGenerator p_275343_, BlockTagsProvider provider, @Nullable ExistingFileHelper existingFileHelper) {
        super(p_275343_, provider, UncraftEverything.MODID, existingFileHelper);
    }
