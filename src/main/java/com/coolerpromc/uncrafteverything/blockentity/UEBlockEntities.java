...
public class UEBlockEntities {
    ...
    public static final Supplier<BlockEntityType<AutoUncraftingTableBlockEntity>> AUTO_UNCRAFTING_TABLE_BE = BLOCK_ENTITIES.register("auto_uncrafting_table_be", () -> BlockEntityType.Builder.of(AutoUncraftingTableBlockEntity::new, UEBlocks.AUTO_UNCRAFTING_TABLE.get()).build(null));
