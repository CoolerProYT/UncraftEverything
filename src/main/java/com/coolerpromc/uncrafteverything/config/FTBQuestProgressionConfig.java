...
public class FTBQuestProgressionConfig {
    ...
    private static final File CONFIG_FILE = new File(FMLPaths.CONFIGDIR.get().toFile(), "uncrafteverything-ftbquest-progression.json");
    ...
    private static net.minecraft.util.ResourceLocation getItemLocation(ItemStack itemStack){
